...
function tryAgain() {
  ...
  rl.question('If you want to try again type \'y\' and to exit type \'n\'', (choice: any) => {
...
function address() {
  rl.question('\n\nEnter Your Address\n\n', (abbr: any) => {
    ...
    if (Address === null || Address === undefined || Address === "") {
      rl.question('If you want to try Again type \'y\' and to exit type \'n\'', ($: any) => {
...
function disInf() {
  ...
  rl.question('If this information true type \'y\' and To input again information type \'n\'', ($$$: any) => {
