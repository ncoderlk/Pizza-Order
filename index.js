...
function tryAgain() {
  rl.question(
    "If you want to try again type 'y' and to exit type 'n'",
    function (choice) {
      switch (choice) {
        case "yes":
          displayMenu();
...
function askQuantity() {
  ...
  rl.question("\n\nHow many 🍕 pizzas do you want ? \n\n", function (quanti) {
    ...
    if (Quantity === null || Quantity === undefined || Quantity === "") {
      ...
      rl.write(
        "\n\nYour Total Price is Generating...(" +
          pizzaPrice +
          "x" +
          Quantity +
          ")\n\n"
...
function disInf() {
  ...
  rl.question(
    "If this information true type 'y' and To input again information type 'n'",
    function ($$$) {
      switch ($$$) {
        case "yes":
          success();
